...
import { getFirestore, collection, doc, addDoc, setDoc, getDocs, getDoc, onSnapshot } from "firebase/firestore";
...
async function getAds() {
  // const querySnapshot = await getDocs(collection(db, "ads")) //once
  const ads = []
  ...
  const q = onSnapshot(collection(db, "ads"), (querySnapshot) => {
    querySnapshot.forEach((doc) => {
